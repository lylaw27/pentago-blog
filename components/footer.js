  ...
  return (
    <section className="footer">
        ...
        <div className="footer-icons">
          ...
          <Link href="https://www.instagram.com/pentagoproperty/"><i className="fab fa-instagram pointer"></i></Link>
          <Link href="https://www.youtube.com/c/ResearcherP"><i className="fa-brands fa-youtube pointer"></i></Link>
          <Link href="https://api.whatsapp.com/send?phone=85251133670"><i className="fab fa-whatsapp pointer"></i></Link>
          <Link href="mailto:cs@pentagoproperty.com"><i className="far fa-envelope pointer"></i></Link>
        </div>
